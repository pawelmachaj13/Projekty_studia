...
HD_PWD='D:/hdmi_vga_zybo/hdmi_vga_zybo.runs/add_pos_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add_pos.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add_pos.tcl
