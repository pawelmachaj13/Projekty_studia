...
HD_PWD='D:/hdmi_vga_zybo/hdmi_vga_zybo.runs/rgb2ycbcr_najnow_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rgb2ycbcr_najnow.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rgb2ycbcr_najnow.tcl
