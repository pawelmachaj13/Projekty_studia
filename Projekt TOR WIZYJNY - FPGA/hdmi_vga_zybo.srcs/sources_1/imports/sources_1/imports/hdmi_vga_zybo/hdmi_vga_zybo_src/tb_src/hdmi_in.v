...
begin
  ...
  begin  
    ...
    //rgbfile = $fopen("C:/Users/pawel/OneDrive/Pulpit/Zajecia/SR/hdmi_vga_zybo/model/dlon_ppm.ppm","rb");
    //rgbfile = $fopen({"D:/hdmi_vga_zybo/obrazy/test_",vsc[5:0]/10+8'h30,vsc[5:0]%10+8'h30,".ppm"},"rb");
        rgbfile = $fopen({"D:/hdmi_vga_zybo/obrazy/test_07.ppm"},"rb");
	 // read header file
